 ...
 * @author graywatson
 */
public class TableInfoImpl<T, ID> implements TableInfo<T, ID>{
	 ...
	 */
	public TableInfoImpl(ConnectionSource connectionSource, BaseDaoImpl<T, ID> baseDaoImpl, Class<T> dataClass)
			throws SQLException {
	 ...
	 */
	public TableInfoImpl(DatabaseType databaseType, BaseDaoImpl<T, ID> baseDaoImpl, DatabaseTableConfig<T> tableConfig)
			throws SQLException {
	...
	/**
	 * @see TableInfo#getFieldTypeByColumnName
	 */
	@Override
	...
	/**
	 * @see TableInfo#isForeignAutoCreate
	 */
	@Override
	...
	/**
	 * @see TableInfo#getForeignCollections
	 */
	@Override
